    ...
    return MultiBlocListener(
        ...
        BlocListener<ProfileBloc, ProfileState>(
          listener: (context, state) {
            ...
            if (state.profileStatus == ProfileStatus.success) {
              context
                  .read<OrderBloc>()
                  .add(GetProfileOrders(limit, 0, 'newest', 'all'));
            }
            if (state.profileStatus == ProfileStatus.successDeletePhone) {
              showToast(
                  text:
      ...
      child: Builder(builder: (context) {
        ...
        return state.isLoaded!
            ? orderState.isProfileOrdersLoaded!
                ? RefreshIndicator(
                    onRefresh: () async {
                      context
                          .read<ProfileBloc>()
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              state.userProfileEntity!.phonesList!.isNotEmpty
                                  ? Padding(
                                      padding: EdgeInsets.symmetric(
                                          horizontal: width * 0.03),
                                      child: Container(
                                        ...
                                        child: ListView.separated(
                                            ...
                                            itemCount: state.userProfileEntity!
                                                .phonesList!.length),
                                      ),
                                    )
                                  : SizedBox(),
