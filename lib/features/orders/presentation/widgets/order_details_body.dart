...
import 'package:zaza_app/features/orders/presentation/widgets/shimmer_order_details_loading.dart';
        ...
        builder: (context, state) {
          return ConditionalBuilder(
            ...
            builder: (context) => RefreshIndicator(
              onRefresh: () async {
                context.read<OrderBloc>().add(GetOrderDetails(orderId));
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListView.separated(
                        ...
                        itemCount: state.orderDetailsEntity!
                            .productsOrderDetailsList!.length,
                      ),
                    ],
                  ),
                ),
            ...
            fallback: (context) => ShimmerOrderDetailsLoading(),
          );
        },
      ),
    );
