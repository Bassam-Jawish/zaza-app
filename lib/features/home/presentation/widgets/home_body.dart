...
import 'package:zaza_app/features/home/presentation/widgets/shimmer_home_loading.dart';
...
class _HomeBodyState extends State<HomeBody> {
  ...
  void initState() {
    BlocProvider.of<DiscountBloc>(context)
        .add(GetHomeDiscountProducts(limit, 0, sort, languageCode));
    ...
    return MultiBlocListener(
        ...
        child: Builder(builder: (context) {
          ...
          return state.isDiscountHomeLoaded!
              ? stateNewProducts.isNewHomeLoaded!
                  ? RefreshIndicator(
                      onRefresh: () async {
                                  ...
                                  itemBuilder: (context, index) =>
                                      BuildDiscountProductCard(
                                          ...
                                          state
                                              ...
                                              .price!),
                                  itemCount: state
                                      .productEntityHome!.productList!.length,
